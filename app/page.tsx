...
import StackedLine from '@/components/stackedLine/index'
export default function Home() {
  return (
    <div>
      <h1 className="text-5xl font-bold text-center px-auto my-10 mb-30">Charts</h1>
      <div className="grid grid-cols-2 gap-10 place-items-center pb-20">
        ...
        <div className="flex flex-col items-center border-2 border-gray-400 w-150">
          ...
          <span className="text-2xl font-medium">AreaStyle</span>
        </div>
        <div className="flex flex-col items-center border-2 border-gray-400 w-150">
          <StackedLine />
          <span className="text-2xl font-medium">StackedLine</span>
        </div>
      </div>
    </div>
  );
